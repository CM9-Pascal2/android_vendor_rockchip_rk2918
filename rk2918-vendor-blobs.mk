...
LOCAL_PATH := vendor/rockchip/rk2918
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/system/lib/libomxvpu.so:system/lib/libomxvpu.so \
    $(LOCAL_PATH)/proprietary/system/lib/libomxvpu_enc.so:system/lib/libomxvpu_enc.so \
    $(LOCAL_PATH)/proprietary/system/lib/libvpu.so:system/lib/libvpu.so \
    $(LOCAL_PATH)/proprietary/system/lib/registry:system/lib/registry \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/proprietary/system/lib/hw/audio.primary.rk29board.so:system/lib/hw/audio.primary.rk29board.so \
    $(LOCAL_PATH)/proprietary/system/lib/hw/audio_policy.rk29board.so:system/lib/hw/audio_policy.rk29board.so \
    $(LOCAL_PATH)/proprietary/system/lib/hw/camera.rk29board.so:system/lib/hw/camera.rk29board.so \
    $(LOCAL_PATH)/proprietary/system/lib/hw/gralloc.rk29board.so:system/lib/hw/gralloc.rk29board.so \
    $(LOCAL_PATH)/proprietary/system/lib/hw/copybit.rk29board.so:system/lib/hw/copybit.rk29board.so \
    $(LOCAL_PATH)/proprietary/system/lib/hw/hwcomposer.rk29board.so:system/lib/hw/hwcomposer.rk29board.so \
    $(LOCAL_PATH)/proprietary/system/lib/hw/lights.rk29board.so:system/lib/hw/lights.rk29board.so \
    $(LOCAL_PATH)/proprietary/system/lib/hw/sensors.rk29board.so:system/lib/hw/sensors.rk29board.so
